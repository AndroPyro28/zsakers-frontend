...
import AddonsLogic from './AddonsLogic';

interface Props {
    setOpenCreateProductModal: React.Dispatch<React.SetStateAction<boolean>>
}

function AddonsCreateModal({ setOpenCreateProductModal }: Props) {
    const [productIds, setProductIds] = useState<number[]>([])

    const { onSubmit, initialValues, validationSchema } = AddonsLogic({productIds})
                    ...
                    formik => {
                        ...
                        return <FormFormik autoComplete='off'>
                            ...
                            <FormFieldContainer>
                                ...
                                <FieldInputContainer>
                                    <Field name="productName" id="productName" type="text" placeholder="Add ons name" />
...
export default AddonsCreateModal