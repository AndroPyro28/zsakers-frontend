...
export const getAddedProductToCheckout = (state: any) => state?.checkout.reduce((total: any, cartProduct: CartProduct) => total + (cartProduct.product.price * cartProduct.quantity)
);
